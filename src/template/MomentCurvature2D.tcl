proc MomentCurvature2D { secTag axialLoad maxK {numIncr 100} } {
	...
	# Create recorder
	recorder Node -file result/@resultFile@.out -time -node 1002 -dof 3 disp;	# output moment (col 1) & curvature (col 2)
	recorder Element -file result/@resultFile@-Elemnt.out -time -ele 2001 section fiber 250.0 300.0 2 stressStrain;
